...
SMODS.Joker {
	...
	loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue + 1] = { key = 'bttiFromBy', set = 'Other', vars = { "The Internet", "Chris Torres" } }
		return {
            vars = { },
        }
	end,
...
SMODS.Joker {
	...
	loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue + 1] = { key = 'bttiFromBy', set = 'Other', vars = { "The Internet", "FrankieDudeUltimate" } }
		return {
            vars = { },
        }
	end,
...
-- SMILING FRIENDS JOKERS
--#region SMILING FRIENDS JOKERS
...
-- HOLLOW KNIGHT JOKERS
--#region HOLLOW KNIGHT JOKERS
...
SMODS.Joker {
	...
	loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue + 1] = { key = 'bttiFromBy', set = 'Other', vars = { "Hollow Knight", "Team Cherry" } }
		return {
            vars = { },
        }
	end,
...
SMODS.Joker {
	...
	loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue + 1] = { key = 'bttiFromBy', set = 'Other', vars = { "Stacey Does", "Juicimated" } }
		return {
            vars = { },
        }
	end,
